...
Primary pages (`index.xhtml`, `ticket-list.xhtml`, `ticket.xhtml`, `user-list.xhtml`, `user.xhtml`) SHALL use the shared layout. Views SHALL prefer PrimeFaces components and PrimeFlex utilities.
